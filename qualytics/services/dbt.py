...
from .rules import (  # noqa: F401 — re-exported for backward compatibility
    CROSS_REF_RULES as _CROSS_REF_RULES,
    Contract,
    RULE_CONTRACT,
    contract_for,
    one_sided_between as _one_sided_between,
...
# _CROSS_REF_RULES, Contract, RULE_CONTRACT and contract_for now live in
# services.rules (shared with the sheet-migration pipeline) and are re-exported
...
# ── Field validation ──────────────────────────────────────────────────────
# resolve_check_fields moved to services.rules (re-exported above).
