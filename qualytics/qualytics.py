...
from .cli.generate_driver import generate_driver_app, package_drivers_app
...
app.add_typer(generate_driver_app, name="generate-driver")
app.add_typer(package_drivers_app, name="package-drivers")
