...
| `migrate` | Create checks and computed containers from a check sheet |
...
| [Check Sheet Migration](docs/migrate.md) | Bulk checks + computed containers from a normalized XLSX/CSV sheet |
